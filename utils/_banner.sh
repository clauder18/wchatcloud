...
print_banner() {
    ...
    print_centered "WchatCloud" "$Green"
    ...
    print_centered "de infringir os direitos autorais da Terabyte Data Center." "$Green"
    print_centered "PIRATEAR ESSA SOLUÇÃO É CRIME." "$Green"
    print_centered "© Terabyte Data Center" "$Green"
